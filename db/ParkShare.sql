...
(
	...
	temppassword varchar(35) not null,
...
alter table parkingowner owner to postgres;
...
alter table parkingspot owner to postgres;
...
alter table parkingspotoccupancy owner to postgres;
...
alter table clientreservation owner to postgres;
