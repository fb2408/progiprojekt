			...
			\subsection{Obrasci uporabe}
    			...
    			\end{packed_item}
    				...
    				\begin{packed_item}
    					...
    					\item  \textbf{Cilj:} Voditelj može voditi evidenciju o zauzetosti parkirališnih mjesta
    					\item  \textbf{Sudionici:} Baza podataka
    					\item  \textbf{Preduvjet:} Korisnik je prijavljen kao voditelj te ima svojih parkirališnih mjesta
    					\item  \textbf{Opis osnovnog tijeka:}
    					
    					\item[] \begin{packed_enum}
    						
    						\item Voditelj odluči vidjeti zauzetost svih svojih parkirališnih mjesta
    					...
    					\item[] \begin{packed_item}
    						...
    						\item[2.a] voditelj nema parkirališnih mjesta
    						\item[] \begin{packed_enum}
    							
    							\item Ispis pogreške 
    							\item Voditelju se pruža mogućnost dodavanja parkirališnog mjesta
    				...
    				\begin{packed_item}
    					...
    					\item  \textbf{Cilj:} Svaki klijent može evidentirati zauzetost o parkirnim mjestima
    					\item  \textbf{Sudionici:} Baza podataka
    					\item  \textbf{Preduvjet:} Korisnik prijavljen kao klijent parkinga te ima parkirnih mjesta
    					\item  \textbf{Opis osnovnog tijeka:}
